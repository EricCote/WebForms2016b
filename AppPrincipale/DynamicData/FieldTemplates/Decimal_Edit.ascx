<%@ Control Language="C#" CodeBehind="Decimal_Edit.ascx.cs" Inherits="AppPrincipale.Decimal_EditField" %>
...
<asp:RangeValidator runat="server" ID="RangeValidator1" CssClass="text-danger h2" ControlToValidate="TextBox1" Type="Double"
