<%@ Control Language="C#" CodeBehind="Integer_Edit.ascx.cs" Inherits="AppPrincipale.Integer_EditField" %>

<asp:TextBox ID="TextBox1" CssClass="form-control col-xs-10" runat="server" Text='<%# FieldValueEditString %>' Columns="10" TextMode="Number"></asp:TextBox>
...
<asp:CompareValidator runat="server" ID="CompareValidator1" CssClass="text-danger h2" ControlToValidate="TextBox1" Display="Static"
